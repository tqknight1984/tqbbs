...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 板块管理 <span class="c-gray en">&gt;</span> 外部板块 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
    	...
    	<div>
    		<div class="row cl" style="margin-bottom:10px;">
				...
				<div class="formControls col-9">
				    <label id="lable_pname1" class="form-label" style="color:#F00;"></label>
				</div>
			</div>
			<div class="row cl">
...
$(function(){
	...
	$("#bt_add").click(function(){
		...
		$.post("${bbs_url}xpabc/admin/plate/add",{plate_name:pname,isin:0},function(data){
			if(data==1){
				alert("成功！");
